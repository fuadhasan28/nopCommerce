    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        protected virtual void CreateCatalogMaps()
        {
            CreateMap<CatalogSettings, CatalogSettingsModel>()
                ...
                .ForMember(model => model.DefaultProductSortingOptionId_OverrideForStore, options => options.Ignore())
                ...
                .ForMember(model => model.AvailableSortingOptions, options => options.Ignore())
